    ...
    <div class="w3-col m7">
      ...
      <?php foreach($feed as $post){ ?>
        ...
        <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
          ...
          <button <?php echo $disable; ?> data-id_post = "<?php echo $post['id_file_post'];?>" type="button" class="like w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-up"> <?php echo $post['like_count'] ?></i></button> 
          <button  type="button" class="w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-comment"></i>  Comment</button>
          <div style="width: 100%">tegi</div> 
        </div>
      <!-- End Middle Column -->
      <?php } ?>
